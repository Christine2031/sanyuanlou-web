...
export const CRM_TRANSLATIONS = {
  sc: {
    ...
    pendingTitle: "申请已呈，静候甄选",
    pendingDesc: "三元楼甄选官将在 24-48 小时内与您确认资格，请留意联系邮箱。",
    approvedTitle: "甄选确认 · 印鉴制卡中",
  ...
  tc: {
    ...
    pendingTitle: "申請已呈，靜候甄選",
    pendingDesc: "三元樓甄選官將在 24-48 小時內與您確認資格，請留意聯絡郵箱。",
    approvedTitle: "甄選確認 · 印鑑制卡中",
  ...
  en: {
    ...
    pendingTitle: "Application Submitted · Awaiting Selection",
    pendingDesc: "A Sanyuanlou Selection Officer will confirm your eligibility within 24-48 hours. Please monitor your email.",
    approvedTitle: "Selection Confirmed · Card Being Issued",
